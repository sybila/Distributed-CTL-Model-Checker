 ...
 */
public class MpiTaskMessenger extends BlockingTaskMessenger<CoordinateNode, RectParamSpace> {
    ...
    @Override
    public void sendTask(int destinationNode, @NotNull CoordinateNode internal, @NotNull CoordinateNode external, @NotNull RectParamSpace colors) {
        throw new UnsupportedOperationException();
        /* TODO @NotNull int[] buffer = new int[2*dimensions + model.parameterCount() + 3];
        buffer[0] = CREATE;
    ...
    @Override
    protected boolean blockingReceiveTask(@NotNull OnTaskListener<CoordinateNode, RectParamSpace> taskListener) {
        ...
        if (recvBuffer[0] == CREATE) {
            ...
            TODO @NotNull RectParamSpace colorSet = TreeColorSet.createFromBuffer(lengths, recvParams);
